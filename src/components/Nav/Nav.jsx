export default function Nav () {
  return (
    <header className='fixed w-[calc(100%-16px)] min-w-fit text-nowrap p-1 gap-2 self-center flex justify-around backdrop-blur-xl bg-black text-pink-200 bg-opacity-40 rounded-md z-50'>
